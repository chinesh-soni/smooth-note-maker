...
import { ShieldCheck, Cloud, PenTool, Lock, AlertCircle, KeyRound } from 'lucide-react';
    ...
    <div className="w-full max-w-md bg-[#202020] rounded-2xl shadow-2xl border border-[#333333] p-8">
      ...
      <div className="space-y-3 mb-8 bg-[#1a1a1a] p-4 rounded-xl border border-[#2d2d2d]">
        ...
        <div className="flex items-center gap-3 text-xs text-slate-600 dark:text-slate-300">
          ...
          <span>Database-free: your data stays completely yours</span>
        </div>
      </div>
      ...
      <p className="text-center text-xs text-slate-400 dark:text-slate-500 mt-6">
        By signing in, Smooth Note Maker creates a dedicated folder in your Google Drive to save your notes.
      </p>
    </div>
  );
};
